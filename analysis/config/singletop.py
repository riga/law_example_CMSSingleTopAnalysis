...
from analysis.config.opendata_2011 import campaign_opendata_2011
...
cfg.add_shift("lumi_up", 2,
    type="rate",
    label="Luminosity",
)
cfg.add_shift("lumi_down", 3,
    type="rate",
    label="Luminosity",
)
cfg.add_shift("jer_up", 4,
    type="shape",
    label="Jet energy resolution",
)
cfg.add_shift("jer_down", 5,
    type="shape",
    label="Jet energy resolution",
)
